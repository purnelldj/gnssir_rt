...
# general parameters
stationdir = gnssir_rt_dir + "/tests/testdata/sjdlr"
sdt = datetime.datetime(2021, 11, 25, 1)  # zenodo data range: 11, 10, 22 to 11, 27, 18
edt = datetime.datetime(2021, 11, 25, 3)  #
antennaids = ["ACM0", "ACM1"]
hgts = [0.2, 0.3]
